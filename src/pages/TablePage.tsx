        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <span className="text-gray-500 dark:text-gray-400">.glnk.dev</span>
            </a>
              ...
              {isAuthenticated && user ? (
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors disabled:opacity-50"
                    type="button"
                  >
                    <GitHubIcon />
      ...
      <main className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-8">
        {links.length > 0 ? (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-4 px-4 text-sm font-medium text-gray-500 dark:text-gray-500 uppercase tracking-wider">
                    Subpath
                  </th>
                  <th className="text-left py-4 px-4 text-sm font-medium text-gray-500 dark:text-gray-500 uppercase tracking-wider">
                    Redirect Link
          ...
          <div className="text-center py-16">
            <p className="text-gray-500 dark:text-gray-400">No links configured yet.</p>
          </div>
        )}
      </main>
    </div>
